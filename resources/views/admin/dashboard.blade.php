    ...
    <div id="content-header">
      ...
      <div class="container-fluid">
        <div class="quick-actions_homepage">
          ...
          <li class="bg_lb"> <a href="{{ url('admin/dashboard') }}"> <i class="icon-dashboard"></i> <span
                class="label label-important"></span> Mon tableau de bord </a> </li>
          {{-- <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> Charts</a> </li> --}}
          @if(Session::get('adminDetails')['categories_view_access']==1)
          <li class="bg_ly"> <a href="{{ url('admin/view-categories') }}"> <i class="icon-inbox"></i><span
                class="label label-success">101</span> Categories </a> </li>
          @endif
          @if(Session::get('adminDetails')['products_access']==1)
          <li class="bg_lo"> <a href="{{ url('admin/view-products') }}"> <i class="icon-inbox"></i><span
                class="label label-success">101</span> Produits </a> </li>
          @endif
          @if(Session::get('adminDetails')['orders_access']==1)
          <li class="bg_ls"> <a href="{{ url('admin/view-orders') }}"> <i class="icon-inbox"></i><span
                class="label label-success">101</span> Commandes </a> </li>
          @endif
          @if(Session::get('adminDetails')['users_access']==1)
          <li class="bg_lr"> <a href="{{ url('admin/view-users') }}"> <i class="icon-inbox"></i><span
                class="label label-success">101</span> Utilisateurs </a> </li>
          @endif
