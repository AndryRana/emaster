...
<head>
        <title>Emaster Admin</title><meta charset="UTF-8" />
        ...
        <div id="loginbox">  
            ...
            <form id="loginform" class="form-vertical" method="post" action="{{ url('admin') }}">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span><input type="password" name="password" placeholder="Mot de passe" required=""/>
                        </div>
                    </div>
                </div>
                <div class="form-actions">
                    <span class="pull-left"><a href="#" class="flip-link btn btn-info" id="to-recover">Mot de passe oublié ?</a></span>
                    <span class="pull-right"><input type="submit"  value="Se connecter" href="index.html" class="btn btn-success" /></span>
                </div>
            </form>
